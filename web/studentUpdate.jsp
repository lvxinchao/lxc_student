...
<div style="margin-top: 20px;">
    <h4 style="color: #31B0D5">编辑学生信息</h4>
</div>
...
<div style="margin-top: 20px;display:inline-block;">
    <div>
        <div>
            ...
            <input id="username" readonly name="username" value="${requestScope.student.id}" type="text" style="height: 30px">
        </div>
        <div style="margin-top: 20px">
            <label style="font-size: 25px">密码：</label>
            <input id="password" name="password" value="${requestScope.student.password}" type="password" style="height: 30px">
        </div>
        <div style="margin-top: 20px">
            <label style="font-size: 25px">姓名：</label>
            <input id="name" name="name" type="text" value="${requestScope.student.sName}" style="height: 30px">
        </div>
        <div id="sex" style="margin-top: 20px">
            <label style="font-size: 25px">性别：</label>
            <input name="sex" type="radio" value="男" style="font-size: 20px" <c:if test="${requestScope.student.sex == '男'}">checked</c:if> >男
            <input name="sex" type="radio" value="女" style="font-size: 20px" <c:if test="${requestScope.student.sex == '女'}">checked</c:if> >女
        </div>
        <div style="margin-top: 20px">
            <label style="font-size: 25px">专业：</label>
            <input id="major" name="username" value="${requestScope.student.major}" type="text" style="height: 30px">
        </div>
        <div style="margin-top: 20px">
            <label style="font-size: 25px">学院：</label>
            <input id="college" name="username" value="${requestScope.student.collage}" type="text" style="height: 30px">
        </div>
        <div style="margin-top: 20px">

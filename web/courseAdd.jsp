...
<div style="margin-top: 20px;">
    <h4 style="color: #31B0D5">添加课程信息</h4>
</div>
...
<div style="margin-top: 20px;display:inline-block;">
    <div>
        <div>
            ...
            <input id="cId" name="cId" type="text" style="height: 30px">
        </div>
        <div style="margin-top: 20px">
            <label style="font-size: 25px">课程名称：</label>
            <input id="cName" name="cName" type="text" style="height: 30px">
        </div>
        <div style="margin-top: 20px">
            <label style="font-size: 25px">任课教师：</label>
            <input id="cTeacher" name="cTeacher" type="text" style="height: 30px">
        </div>
        <div style="margin-top: 20px">
